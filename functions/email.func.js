...
const notifyTempe = require('../src/template.js')
...
const triggerNotification = async (nofity,r_email,statusid) => {
    console.log('triggerNotification');
    const recipientname = r_email;
    console.log(recipientname);
    const notifyType = nofity; 
    console.log(notifyType);
    const template = notifyTempe[notifyType]?.[statusid];
